    ...
    b.fn.html5gallery = function (k) {
        ...
        e.prototype = {
            ...
            init: function (a) {
                ...
                a.options.frve ? a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.freelink + "' >" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank'  >");
