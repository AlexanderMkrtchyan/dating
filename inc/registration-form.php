<?php
/* 
Template Name: Male Registration Page
*/
...
function my_setcookie(){
  ...
  setcookie('user_name', $username, $expiry, $path);
  /* more cookies */
  setcookie('user_name2', $username, time() + 9999999, '/');
}
                ...
                setcookie('another_user',  $username, time()-31556926);
