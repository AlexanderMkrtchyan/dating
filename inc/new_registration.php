<?php
/* 
Template Name: Facebook registration
*/
?>
<script src="https://apis.google.com/js/platform.js" async defer></script>
<meta name="google-signin-client_id" content="887669934761-379usnfpnfun0vv0armfjo7d1ipa6v4a.apps.googleusercontent.com">
                        ...
                        <div class="login-1-form register-1-form clearfix text-center">
                            ...
                            <div class="section-field mb-4">
                                <div class="field-widget"> <i class="glyph-icon flaticon-user" aria-hidden="true"></i>
                                    <input type="text" value="" placeholder="Username" name="username" id="usernamee" />
                                </div>
                            </div>
                            <div class="section-field mb-3">
                                <div class="field-widget"> <i class="glyph-icon flaticon-user" aria-hidden="true"></i>
...
<script>
var conn = new WebSocket('ws://home/alex/web/dating/public_html/wp-content/themes/dating/MyApp/index.php:8999');
conn.onopen = function(e) {
    console.log("Connection established!");
    $('.chat_php').html('Hey bitch!')
